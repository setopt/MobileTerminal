...
include ('bdi.php');
				 ...
				 if (isset($_POST['submit'])){
					 $name = $_POST['name'];
					 $sqlInsert = "INSERT INTO `Position`(`Name`) VALUES ('$name')";
      ...
      <div class="navbar-collapse">
        ...
        <div class = "bg-dark" id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a  style="color: #FFF;" href="position.php">Должности</a>
                </li>
            </ul>
        </div>
        <!-- /#sidebar-wrapper -->
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
               ...
               <table class="table">
				  ...
				  <tbody>
				  <?php
							$sql = "SELECT `ID_Position`, `Name` FROM `Position`";
							//$date = $_POST['dateV'];
							//$position = $_POST['position'];
							$result = mysqli_query($db,$sql);
							$i = 1;
							while ($myrow = mysqli_fetch_assoc($result)){
								$id = $myrow['ID_Position'];
								echo $doc = "<tr><th scope='row'>".$i."</th><td>".$myrow["Name"]."</td><td><a href = ''>Редактировать</a><br /><a href ='scriptDel.php?table=Position&id=$id&idname=ID_Position'>Удалить</a></td></tr> ";
							$i++;
							}
							?>
				    </tbody>
